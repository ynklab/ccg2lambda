...
plain_dir="/home/$USER/ccg2lambda/snli/scratch/plain" # tokenized sentences.
parsed_dir="/home/$USER/ccg2lambda/snli/scratch/parsed" # parsed sentences into XML or other formats.
results_dir="/home/$USER/ccg2lambda/snli/scratch/results" # HTML semantic outputs, proving results, etc.
...
rm ${plain_dir}/${sentences_basename}.tok
rm ${parsed_dir}/${sentences_basename}.candc.xml
rm ${parsed_dir}/${sentences_basename}.log
rm ${parsed_dir}/${sentences_basename}.xml
rm ${parsed_dir}/${sentences_basename}.sem.err
rm ${results_dir}/${sentences_basename}.html
rm ${results_dir}/${sentences_basename}.err
